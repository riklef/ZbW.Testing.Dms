namespace ZbW.Testing.Dms.Client.ViewModels
{
    ...
    internal class SearchViewModel : BindableBase
    {
        ...
        public SearchViewModel()
        {
            ...
            FilteredMetadataItems = _docService.GetMetadataItems();
            _docService.MetadataItems = _docService.GetMetadataItems();
        }
        ...
        private void OnCmdOeffnen()
        {
            ...
            _docService.OpenFile(SelectedMetadataItem._filePath);
        }

        private void OnCmdSuchen()
        {
            // TODO: Add your Code here
            FilteredMetadataItems = _docService.FilterMetadataItems(_suchbegriff, SelectedTypItem);
        }

        private void OnCmdReset()
        {
            // TODO: Add your Code here
            FilteredMetadataItems = _docService.MetadataItems;
            Suchbegriff = "";
